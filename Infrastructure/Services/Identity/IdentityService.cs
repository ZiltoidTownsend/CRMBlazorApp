...
public class IdentityService : ITokenService
{
    ...
    public IdentityService(
        UserManager<CRMUser> userManager, RoleManager<IdentityRole> roleManager,
        IOptions<AppConfiguration> appConfig, SignInManager<CRMUser> signInManager)
    ...
    private async Task<string> GenerateJwtAsync(CRMUser user)
    {
        var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
        return token;
    }

    private async Task<IEnumerable<Claim>> GetClaimsAsync(CRMUser user)
    {
